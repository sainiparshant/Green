...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#02352d] text-white relative overflow-hidden">
      ...
      <button
        onClick={scrollToTop}
        className="absolute cursor-pointer bottom-14 right-4 md:bottom-8 md:right-8 w-9 h-9 md:w-12 md:h-12 rounded-full bg-emerald-500 hover:bg-emerald-600 flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 z-20 group"
